...
function moveDown() {
    ...
    grid-column-start: ${(getComputedStyle(popeye).gridColumnStart)};
    grid-column-end: ${(getComputedStyle(popeye).gridColumnEnd)};
    grid-row-start:${(parseInt(getComputedStyle(popeye).gridRowStart) + 1) > 3 ? 1 : parseInt(getComputedStyle(popeye).gridRowStart) + 1} ;
    grid-row-end:${(parseInt(getComputedStyle(popeye).gridRowEnd) + 1) > 4 ? 2 : parseInt(getComputedStyle(popeye).gridRowEnd) + 1}  ;
...
function moveRight() {
    popeye.style.cssText = `
        grid-column-start: ${(parseInt(getComputedStyle(popeye).gridColumnStart) + 1) > 6 ? 1 : parseInt(getComputedStyle(popeye).gridColumnStart) + 1};
        grid-column-end: ${(parseInt(getComputedStyle(popeye).gridColumnEnd) + 1) > 7 ? 2 : parseInt(getComputedStyle(popeye).gridColumnEnd) + 1};
